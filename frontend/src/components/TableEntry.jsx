...
//         `http://localhost:5000/api/sets/fetchSets?subject=${subject}&&setNumber=${setNum}`,
//         {
//           method: "GET",
//           headers: {
...
//     }));
//   };
//   const fetchSetDetailsDebounced = debounce(async (setNum, rollNumber, setSetDetails) => {
//     const token = localStorage.getItem("token");
//     if (!token) {
//       alert("You are not authenticated. Please login.");
//       return;
...
//   // useEffect to fetch set details when setNumbers change
//   useEffect(() => {
//     Object.entries(setNumbers).forEach(([rollNumber, setNum]) => {
//       if (setNum > 0) {
//         fetchSetDetailsDebounced(setNum, rollNumber);
...
//   // Effect to fetch details when setNumbers change
//   useEffect(() => {
//     Object.entries(setNumbers).forEach(([rollNumber, setNum]) => {
...
//   // Function to handle set number change
...
//   //   if (Object.keys(setNumbers).length) {
//   //     Object.entries(setNumbers).forEach(([rollNumber, setNum]) => {
//   //       if (setNum) fetchSetDetailsDebounced(setNum, rollNumber); // Ensure only valid set numbers trigger the fetch
//   //     });
//   //   }
//   // }, [setNumbers]);
...
//   //     // Fetch details for this roll number only
//   //     if (value) {
...
//below code return code
 ...
 //   return (
  ...
  //                 <th>CO Mapping 1</th>
  //                 <th>Write Up</th>
  //                 <th>Compile Errors</th>
  //                 <th>Execution</th>
  //                 <th>Program 2</th>
  //                 <th>CO Mapping 2</th>
  //                 <th>Program & Syntax</th>
  //                 <th>Viva-Voice</th>
  //                 <th>Total</th>
  //               </tr>
  //             </thead>
  ...
  //                     />
  //                   </td>
  //                   <td>{setDetails[rollNumber]?.program1?.join(", ") || ""}</td>
  //                   <td>{setDetails[rollNumber]?.co1?.join(", ") || ""}</td>
  //                   <td>
  //                     <input
  //                       type="number"
  //                       value={marks[rollNumber]?.writeUp || ""}
  ...
  //                     />
  //                   </td>
  //                   <td>{setDetails[rollNumber]?.program2?.join(", ") || ""}</td>
  //                   <td>{setDetails[rollNumber]?.co2?.join(", ") || ""}</td>
  //                   <td>
  //                     <input
  //                       type="number"
  //                       value={marks[rollNumber]?.programSyntax || ""}
  ...
  //                     />
  //                   </td>
  //                   <td>{calculateTotalMarks(rollNumber)}</td>
  //                 </tr>
  //               ))}
  //             </tbody>
  //           </table>
